...
$.getJSON( "/lineup.json", function( data ) {
  ...
  $.each( data, function( key, val ) {
    ...
    $('#artist-container').append("<div type='button' " +  "data-toggle='modal'" + "data-target='a" + key + "'" + "class='card card-inverse btn col-sm-4 artist-thumbnail col-xs-6 col-md-3 col-lg-3'>" + "<div class='card' id='" + key + "'>" + "<div class='artist-title card-content'>" + "<h2 class='card-title'>" + artistName + "</h2>" + "</div>" + "</div>" + "</div>");
...
//=================================[ Modal Creation ]====================================//
let createModal = function(key, artistName, artistBio, artistImg ) {
